        ...
        private static List<UILayerDefinition> CreateDefaultLayers()
        {
            return new List<UILayerDefinition>
            {
                new UILayerDefinition
                {
                    ...
                    sortingOrder = UIFrameworkConstants.LAYER_BACKGROUND_SORTING_ORDER,
                    blocksRaycasts = false
                },
                new UILayerDefinition
                {
                    layerType = UILayerType.SceneOverlay,
                    sortingOrder = UIFrameworkConstants.LAYER_SCENE_OVERLAY_SORTING_ORDER,
                    blocksRaycasts = false
                },
                new UILayerDefinition
                {
                    layerType = UILayerType.Default,
                    sortingOrder = UIFrameworkConstants.LAYER_DEFAULT_SORTING_ORDER,
                    blocksRaycasts = true
                },
                new UILayerDefinition
                {
                    layerType = UILayerType.Popup,
                    sortingOrder = UIFrameworkConstants.LAYER_POPUP_SORTING_ORDER,
                    blocksRaycasts = true
                },
                new UILayerDefinition
                {
                    layerType = UILayerType.System,
                    sortingOrder = UIFrameworkConstants.LAYER_SYSTEM_SORTING_ORDER,
                    blocksRaycasts = true
                },
                new UILayerDefinition
                {
                    layerType = UILayerType.Debug,
                    sortingOrder = UIFrameworkConstants.LAYER_DEBUG_SORTING_ORDER,
                    blocksRaycasts = false
                }
            };
        }
