...
public class UIBadgePopMotion : UIEmphasisOnlyMotion
{
    ...
    {
        new UIMotionClip { action = UIMotionAction.Normal, pose = new UIMotionPose(), duration = 0.1f, ease = Ease.OutQuad },
    ...
    public override void PrepareEnter() => SetImmediate(UIMotionAction.Hide);
