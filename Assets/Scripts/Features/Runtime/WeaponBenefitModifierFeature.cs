...
[Serializable]
public sealed class WeaponBenefitModifierFeature : FeatureEffectBase
{
    [SerializeField] private WeaponBenefitData benefitBonus;
    private string runtimeSourceId;

    public WeaponBenefitModifierFeature()
    {
    }

    public WeaponBenefitModifierFeature(WeaponBenefitData benefitBonus)
    {
    ...
    private string ResolveRuntimeSourceId()
    {
        ...
        return string.IsNullOrWhiteSpace(SourceId)
            ? $"{nameof(WeaponBenefitModifierFeature)}_{GetHashCode()}"
            : $"{SourceId}:{nameof(WeaponBenefitModifierFeature)}_{GetHashCode()}";
    }
