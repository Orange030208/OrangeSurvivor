...
public sealed class StageDirectorProfileSO : ScriptableObject
{
    ...
    [FormerlySerializedAs("defaultSpawnLocation")]
    [SerializeField] private SpawnLocationDefinition defaultSpawnRule = SpawnLocationDefinition.CreateDefault();
    ...
    public SpawnLocationDefinition DefaultSpawnRule => defaultSpawnRule;
        ...
        SpawnLocationDefinition defaultSpawnRule)
    {
        ...
        this.defaultSpawnRule = defaultSpawnRule ?? SpawnLocationDefinition.CreateDefault();
        OnValidate();
    }
    ...
    private void OnValidate()
    {
        ...
        defaultSpawnRule ??= SpawnLocationDefinition.CreateDefault();
        defaultSpawnRule.Validate();
    }
}
