...
public class ShopManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        GameEventBus.Publish(new RequestCurrencySnapshotEvent(CurrencyType.Currency));
    }
    ...
    {
        if (eventData.CurrencyType != CurrencyType.Currency)
        {
            return;
        }
    ...
    private void ProcessAccessoryPurchase(ShopItemData itemData, int itemIndex)
    {
        ...
        GameEventBus.Publish(new CurrencyChangeRequestedEvent(CurrencyType.Currency, -price));
    ...
    private void OnRerollRequested()
    {
        ...
        GameEventBus.Publish(new CurrencyChangeRequestedEvent(CurrencyType.Currency, -rerollCost));
        RerollShopItems();
        PublishShopItems();
    }
