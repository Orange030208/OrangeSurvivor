...
[Serializable]
[MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp", sourceClassName: "UISpriteSequenceMotionTrack")]
public sealed class UISpriteSequenceMotionTrack : UIMotionTrackDefinition
{
    ...
    {
        if (!targets.TryGetImage(TargetKey, out Image image) || frames == null || frames.Count == 0)
        {
            return;
        }
