...
- `Assets/GameContent/Upgrades/Facts/`
...
Assets/GameContent/
  Catalog/
    Game Content Catalog.asset
    Pools/
      Chest Reward Pool.asset
      Drop Pool.asset
      Shop Pool.asset
      Weapon Reward Pool.asset
  Upgrades/
    Facts/
    Pools/
      Upgrade Card Pool.asset
  Waves/
    Pools/
      Wave Spawn Pool.asset
  Accessories/
    Data/
  Weapons/
    Data/
...
`Assets/GameContent/Upgrades/Pools/Upgrade Card Pool.asset`
...
`Assets/GameContent/Catalog/Pools/Chest Reward Pool.asset`
...
`Assets/GameContent/Catalog/Pools/Shop Pool.asset`
...
`Assets/GameContent/Catalog/Pools/Drop Pool.asset`
...
`Assets/GameContent/Waves/Pools/Wave Spawn Pool.asset`
...
`Assets/GameContent/Catalog/Pools/Weapon Reward Pool.asset`
...
- 新武器进入 `Assets/GameContent/Weapons/Data` 后，可通过迁移工具更新池。
...
2. 放入 `Assets/GameContent/Accessories/Data`。
3. 运行迁移工具。
...
1. 创建 `WeaponDataSO`。
2. 放入 `Assets/GameContent/Weapons/Data`。
3. 运行迁移工具。
...
```powershell
rg -n "UpgradeCardPoolSO|UpgradeCardOfferContext|UpgradeCardOfferConditions|WaveEnemySpawnCandidate|WaveEnemySpawnOption|ACCESSORY_WEIGHT|WEAPON_WEIGHT|Default Upgrade Card Pool" Assets/Scripts Assets/Tests Assets/GameContent
```
...
- 策划主要维护 `Assets/GameContent/Catalog/Pools/`、`Assets/GameContent/Upgrades/Pools/`、`Assets/GameContent/Waves/Pools/` 和 `Assets/GameContent/Upgrades/Facts/`。
